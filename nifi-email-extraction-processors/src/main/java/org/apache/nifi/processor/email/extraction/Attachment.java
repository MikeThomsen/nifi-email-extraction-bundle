...
public class Attachment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2243069980434546934L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Attachment\",\"namespace\":\"org.apache.nifi.processor.email.extraction\",\"fields\":[{\"name\":\"data\",\"type\":\"bytes\"},{\"name\":\"file_name\",\"type\":\"string\"},{\"name\":\"mime_type\",\"type\":\"string\"},{\"name\":\"size\",\"type\":\"int\"}]}");
   ...
   */
  public static org.apache.nifi.processor.email.extraction.Attachment.Builder newBuilder() {
    return new org.apache.nifi.processor.email.extraction.Attachment.Builder();
  }
   ...
   * @return A new Attachment RecordBuilder
   */
  public static org.apache.nifi.processor.email.extraction.Attachment.Builder newBuilder(org.apache.nifi.processor.email.extraction.Attachment.Builder other) {
    return new org.apache.nifi.processor.email.extraction.Attachment.Builder(other);
  }
   ...
   * @return A new Attachment RecordBuilder
   */
  public static org.apache.nifi.processor.email.extraction.Attachment.Builder newBuilder(org.apache.nifi.processor.email.extraction.Attachment other) {
    return new org.apache.nifi.processor.email.extraction.Attachment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Attachment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.apache.nifi.processor.email.extraction.Attachment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.apache.nifi.processor.email.extraction.Attachment other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.data)) {
        this.data = data().deepCopy(fields()[0].schema(), other.data);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder setData(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder clearData() {
      data = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder setFileName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder clearFileName() {
      file_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder setMimeType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder clearMimeType() {
      mime_type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder setSize(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.nifi.processor.email.extraction.Attachment.Builder clearSize() {
